...
| profiles.cue.backend_ece                    | http://ece.example.com                                 | Not needed if ECE & CUE are on the same machine      |
| profiles.cue.backend_ece_local              | http://localhost:8080                                  | Not needed if ECE & CUE are on the same machine      |
