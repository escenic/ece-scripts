...
| profiles.cue.backend_bridge                 | http://bridge.example.com                              | Bridge URL                                                          |
| profiles.cue.backend_ece                    | http://ece.example.com                                 | How CUE (the browser) finds ECE. Optional on single machine systems |
| profiles.cue.backend_ece_local              | http://localhost:8080                                  | How the web server finds ECE. Optional on single machine systems    |
| profiles.cue.backend_ng                     | http://ng.example.com                                  | Newsgate URL                                                        |
| profiles.cue.cors_origins[]                 | edit.example.com                                       | Allowed CORS origins                                                |
| profiles.cue.install                        | true                                                   | Web server with CORS & CUE web                                      |
| profiles.db.host                            | Database server hostname                               | Useful if DB is running on a different machine                      |
| profiles.db.install                         | true                                                   | Database + ECE schema. Fails if schema exists                       |
| profiles.db.port                            | Database server port                                   | Useful if DB is running on a different machine                      |
| profiles.editor.deploy_white_list           | "webservice indexer-webservice"                        | Space separated list of webapps to deploy.                          |
| profiles.editor.host                        | editor1.example.com                                    | Default is =localhost=                                              |
| profiles.editor.install                     | yes                                                    | Will install an editorial ECE instance                              |
| profiles.editor.port                        | 8180                                                   | Overrides the port number                                           |
| profiles.presentation.deploy_white_list     | "sports the-daily"                                     | Space separated list of webapps to deploy.                          |
| profiles.presentation.host                  | pres1.example.com                                      | Default is =localhost=                                              |
| profiles.presentation.install               | yes                                                    | Only interesting if using JSPs/Widget Framework                     |
| profiles.presentation.port                  | 8180                                                   | Overrides the port number                                           |
...
| profiles.search.host                        | search1.example.com                                    | Default is =localhost=                                              |
...
| profiles.sse_proxy.exposed_port             | 80                                                     | Port on which the browser will access the proxy                     |
